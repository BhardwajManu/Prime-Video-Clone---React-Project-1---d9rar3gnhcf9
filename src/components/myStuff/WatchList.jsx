...
const WatchList = () => {
  const { alreadyFetchedWatchlist, createWatchlist, isFetch, shows } =
    useWatchlistContext();
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 px-20 h-[75vh]">
        <div>
          <h1 className="text-5xl text-[#FFFFFF] py-4 font-bold">Watchlist</h1>
        </div>
        ...
        <div className="flex justify-between ">
          <div className="flex gap-3">
            <Link to="/watchlist">
              {" "}
              <button className="text-2xl bg-[#FFFFFF33] py-[12px] px-[21px] text-[#FFFFFF] rounded-lg font-medium hover:bg-white hover:text-black">
                All
              </button>
            </Link>
            <Link to="/watchlist">
              <button className="text-2xl hidden sm:block bg-[#FFFFFF33] py-[12px] px-[21px] text-[#FFFFFF] rounded-lg font-medium hover:bg-white hover:text-black">
                Movies
              </button>
            </Link>
