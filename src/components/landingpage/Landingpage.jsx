...
import amc from "../../assets/images/amcc.png";
    ...
    <>
      ...
      <div className="relative">
        <div
          className={`${bigimg}`}
          style={{
            backgroundImage: `linear-gradient( to right,#000 40%,transparent 58% ),url(${firstImage})`,
          }}
        ></div>
        <div
          className={`${smallimg}`}
          style={{
            backgroundImage: `linear-gradient( to top, #000 0%, transparent 20% ),url(${smallImage})`,
          }}
        ></div>
        <div className="md:p-10 p-4 md:absolute text-white  md:w-1/2 top-0 left-0">
          <h1 className="font-medium text-[44px] mb-4">
          ...
          <p className="md:hidden text-xl align-middle">
            Watch the latest movies, TV shows, and award-winning Amazon
            Originals
          </p>
          {authenticated ? (
            <div className="flex flex-col">
              ...
              <PlanDetails />
              <Link to="/anonymous">
                <button className={`${plansButton} leading-tight`}>
                  View all plans
                </button>
              </Link>
            </div>
            ...
            <Link to="signinpage">
              <button className={`${plansButton}text-[17px] mt-4`}>
      ...
      <div className="relative">
        <div
          className={`${bigimg}`}
          style={{
            backgroundImage: `linear-gradient( to right, #000 40%, transparent 58% ),url(${secondimg})`,
          }}
        ></div>
        <div
          className={`${smallimg}`}
          style={{
            backgroundImage: `linear-gradient( to top, #000 0%, transparent 20% ),url(${secondimgsmall})`,
          }}
        ></div>
        <div className="md:p-10 p-4 md:absolute text-white  md:w-1/2 top-16 left-0">
          ...
          <p className="md:hidden text-xl align-middle">
            WEarly Access to new movies, before digital subscription
          </p>
          <Link to="/rent">
            <button className={`${plansButton}text-[17px] mt-4`}>
              Rent now
      ...
      <div className="relative">
        <div
          className={`${bigimg}`}
          style={{ backgroundImage: `url(${thirdimgbig} )` }}
        ></div>
        <div
          className={`${smallimg}`}
          style={{ backgroundImage: `url( ${thirdimgsmall})` }}
        ></div>
        <div className="md:p-10 p-4 md:absolute text-white  md:w-1/2 top-20 right-0 ">
          ...
          <p className="hidden md:block  text-xl">
            ...
            title you want to watch to find it in seconds.
          </p>
          <p className="md:hidden text-xl align-middle">
            The biggest movies and TV shows are always better on a big
            screen.Simply plug in your Amazon Fire TV Stick and stream on any
            HDTV.Press the voice button on the remote and say the name of the
            title you want to watch to find it in seconds.
          </p>
          <Link to="/anonymous">
      ...
      <div className="bg-white flex flex-col md:flex-row md:justify-evenly">
        <div className="md:w-1/2  text-black my-9 ml-12">
          <h1 className="text-3xl md:text-6xl font-thin sm:text-4xl  ">
      ...
      <div className="relative">
        <div
          className={`${bigimg}`}
          style={{
            backgroundImage: `linear-gradient( to right, #000 40%, transparent 58% ),url(${kidimgbig})`,
          }}
        ></div>
        <div
          className={`${smallimg}`}
