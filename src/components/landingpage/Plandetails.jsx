    ...
    return (
        <>
            <div className="mt-2.5 mb-2.5 ml-16">
                <span onClick={toggleModal} className="btn-modal text-lg font-semibold underline hover:no-underline py-1 px-2 cursor-pointer">ⓘ Plan details</span>
            </div>
                ...
                <div className="modal-overlay">
                    <div className="modal">
                        <div className="modal-content">
                            <TfiClose onClick={toggleModal} className="cross-button ml-auto" />
