        ...
        <div className="h-screen w-screen relative">
            ...
            <div className="md:p-10 p-4 md:absolute md:w-1/2 top-0 left-0 flex flex-col items-center justify-center md:mt-36 mt-16">
                ...
                <div className="flex gap-10 mt-8">
                    <Link to='https://www.facebook.com/PrimeVideoIN/'>
                        <span className="text-white text-2xl "><FaSquareFacebook />
                        </span>
                    </Link>
                    <Link to='https://www.instagram.com/primevideoin/'>
                        <span className="text-white text-2xl"><GrInstagram />
                        </span>
                    </Link>
                    <Link to='https://twitter.com/PrimeVideoIN?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor'>
                        <span className="text-white text-2xl"><BsTwitter />
                        </span>
                    </Link>
                </div>
            </div>
