      ...
      >
        {images.map((item, i) => (
          <div key={i} className=" m-auto  relative overflow-hidden ">
            ...
            />
            <section
              className="w-full lg:w-[40%] h-full absolute left-1 top-3 border-5 border-solid border-red md:pl-12
                         px-2 flex flex-col justify-around"
            >
              <div>
                <a>
                  <div className=" w-[50%]">
              ...
              <div className=" lg:flex gap-0.5 hidden my-10 mx-10">
                <Link to="https://www.amazon.in/events/greatindianfestival?ref_=atv_me_pri_c_eiVJLU_zMbofx_1_1">
                  <button
                    className="bg-[#FFFFFF] text-[#00050D] w-[155.48px] h-[62px] text-[1.3vw]  px-[21px] mb-14
                            rounded-lg text-left opacity-[1]  font-semibold  min-h-[62px] cursor-pointer"
                  >
                    More details
                  </button>
                </Link>
