...
const UserSetting = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await patch("/user/updateMyPassword", {
            name: user.name, email: user.email, passwordCurrent: currentPassword,
            password: password, appType: "ott"
        })
        console.log(data);
    };
    ...
    return (
        <div className='w-full'>
            <div className='w-full min-h-screen bg-white py-5'>
                <form onSubmit={handleSubmit} className='w-[350px] mx-auto flex flex-col items-center'>
                    ...
                    <div className='w-full border border-zinc-200 p-6'>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <button
                                className='w-full py-1.5 text-sm font-normal rounded-sm bg-[#F7CA00] hover:bg-gradient-to-b border 
                ...
                <div className='w-full mt-4 bg-gradient-to-t from-white via-white to bg-gray-50 flex flex-col items-center
                 justify-center py-10'>
                    <div className='flex flex-col gap-6 items-center'>
                        <div className='flex items-center gap-6'>
                            <Link to="/learnmore"><p className='text-blue-600 hover:text-orange-700 hover:underline underline-offset-1 
                            cursor-pointer'>
                                Terms and Privacy Notice
                            </p></Link>
                            <Link to="/signinpage"><p className='text-blue-600 hover:text-orange-700 hover:underline underline-offset-1
                             cursor-pointer'>
                                Send us feedback
                            </p></Link>
                            <Link to="/help"><p className='text-blue-600 hover:text-orange-700 hover:underline underline-offset-1
                             cursor-pointer'>Help</p></Link>
                        </div>
                        <div>
