      ...
      <div className="w-full min-h-screen bg-white py-5 ">
        ...
        >
          ...
          <div className="w-full border border-zinc-200 p-6  rounded-lg">
            <h2 className="font-titleFont text-2xl sm:text-3xl font-medium mb-4">
              Sign in
            </h2>
            ...
            <p className="text-xs sm:text-sm text-black leading-4 mt-4">
              By continuing, you agree to the Amazon <br />
              <Link to="/learnmore">
                <span
                  className="text-blue-600 hover:text-orange-700 hover:underline underline-offset-1 
                        cursor-pointer"
                >
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-4 cursor-pointer flex items-center gap-1 group">
              ...
              <Link to="/help">
                <span
                  className="text-xs sm:text-sm text-blue-600 group-hover:text-orange-700
          ...
          <Link to="/signuppage">
            <button
              className="w-full py-1 sm:py-1 px-4 mt-4   font-normal rounded-md  hover:bg-gradient-to-b border
                         border-zinc-400 active:border-yellow-800 active:shadow-amazonInput"
            >
        ...
        <div
          className="w-full mt-4 bg-gradient-to-t from-white via-white to bg-gray-100 flex flex-col items-center 
