                ...
                <form onSubmit={handleSubmit} className='w-[370px] mx-auto flex flex-col items-center'>
                    ...
                    <div className='w=full border border-zinc-200 p-6 rounded-lg'>
                        ...
                        <div className='flex flex-col gap-3 '>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <input className={`w-full py-1 border border-zinc-400 px-2 text-base rounded-md outline-none 
                            ...
                            <button className='w-full py-1.5 text-sm font-normal rounded-lg bg-[#F7CA00] hover:bg-gradient-to-b border 
                        ...
                        <Link to="/learnmore"><p className='text-blue-600 text-[12px] hover:text-orange-700 hover:underline 
                        underline-offset-1 cursor-pointer'>Conditions of Use and Privacy Notice.</p></Link>
                    </div>
                    ...
                    <div>
                        <p className='text-[14px] text-black flex justify-start gap-2'>Already have an account?
                            <Link to="/signinpage"
                                className='text-blue-600 hover:text-orange-600 hover:underline underline-offset-1 cursor-pointer 
                                duration-100'>
                                Sign in
                            </Link>
            ...
            <div className='w-full bg-gradient-to-t from-white via-white to bg-gray-50 flex flex-col items-center justify-center py-6'>
                <div className='flex flex-col gap-6 items-center justify-center'>
                    <div className='flex items-center gap-6'>
                        <Link to="/learnmore">
                            <p className='text-blue-600 text-xs hover:text-orange-700 hover:underline underline-offset-1 cursor-pointer'>
