        ...
        <div className="wid-full bg-white py-5">
          ...
          >
            ...
            <div className="w=full border border-zinc-200 p-6 rounded-lg">
              ...
              <p className="text-[14px] test-black leading-4 mt-4">
                By creating an account, you agree to the Amazon
              </p>
              <Link to="/learnmore">
                <p
                  className="text-blue-600 text-[12px] hover:text-orange-700 hover:underline 
            ...
            <div>
              <p className="text-[14px] text-black flex justify-start gap-2">
                ...
                <span>
                  <BiSolidRightArrow className="w-2 mt-[4px] ml-[1px] group" />
                </span>
              </p>
            </div>
          </form>
