...
const Card = ({ movie }) => {
  ...
  return (
    <div
      key={movie._id}
      className="ml-[1.6%]  grandparent-card shadow-md hover:z-50"
    >
      <div className="parent-card group relative">
        ...
        <div
          className="card hidden w-[130%] max-w-[300px] z-[50] group-hover:block font-bold absolute top-0 left-0
                 bg-black rounded-lg"
        >
          <Link to={`/details/${movie._id}`}>
            <img
          ...
          <div className="px-5 cursor-default">
            ...
            <div className="flex justify-between py-2">
              ...
              <div className="flex justify-between gap-2">
                {authenticated ? (
                  <span
                    className="cursor-pointer rounded-full bg-[#33373D] w-[40px] h-[40px] text-white 
                ...
                <Link to={`/details/${movie._id}`}>
                  <span
                    className="rounded-full bg-[#33373D]  w-[40px] h-[40px] text-white flex justify-center
                                     movies-center items-center"
                  >
                    <BiSolidVideos />
                  </span>
                </Link>
