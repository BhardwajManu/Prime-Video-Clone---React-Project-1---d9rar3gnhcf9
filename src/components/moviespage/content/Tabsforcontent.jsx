...
const Tabsforcontent = () => {
  ...
  const content =
    selectedButton === "related" ? <Relateddetail /> : <Moviedetails />;
  ...
  return (
    <>
      <a href="#detail" id="detail" className="relative z-50">
        <div
          ref={detailsRef}
          className=" mx-auto sticky top-16 max-w-5xl h-12 px-2 sm:px-6 lg:px-8  rounded-lg flex justify-center 
        ...
        >
          ...
          <button
            ...
            className={`relative  ${
              selectedButton === "related" ? "selected" : ""
            }`}
          >
            <div
              className={`px-4 h-12 pt-2 relative hover:bg-[rgb(0,5,13)] tracking-wide 
                        ${
                          selectedButton === "related"
                            ? "text-white"
            ...
            <div
              className={`absolute bottom-0 h-[2px] w-full ${
                selectedButton === "related" ? " bg-white" : ""
              }`}
            ></div>
          </button>
          <button
            ...
            className={`relative button ${
              selectedButton === "details" ? "selected" : ""
            }`}
          >
            <div
              className={`px-4 h-12 pt-2 relative hover:bg-[rgb(0,5,13)] tracking-wide 
            ...
            <div
              className={`absolute bottom-0 h-[2px] w-full ${
                selectedButton === "details" ? " bg-white" : ""
              }`}
            ></div>
          </button>
          <div className="absolute rounded-lg bg-[#33373D]"></div>
        </div>
