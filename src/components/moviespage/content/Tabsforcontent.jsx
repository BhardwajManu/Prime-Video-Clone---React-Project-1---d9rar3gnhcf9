    ...
    return (
        <>
            ...
            <a href='#detail' id='detail' className='relative z-50' >
                <div
                    ref={detailsRef} className=' mx-auto sticky top-16 max-w-5xl h-12 px-2 sm:px-6 lg:px-8  rounded-lg flex justify-center 
                items-center text-xl font-semibold'>
                    ...
                    >
                        <div className={`px-4 h-12 pt-2 relative hover:bg-[rgb(0,5,13)] tracking-wide 
                        ${selectedButton === 'related' ? "text-white" : "text-gray-400 hover:text-white"}`}>
                            Related
                        </div>
                    ...
                    >
                        <div className={`px-4 h-12 pt-2 relative hover:bg-[rgb(0,5,13)] tracking-wide 
                        ${selectedButton === 'details' ? "text-white" : "text-gray-400 hover:text-white"}`}>
                            Details
                        </div>
