    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-[#AAAAAA]">{data?.data?.type}</span>
        </div>
        <div className="flex flex-col gap-2">
          <span className={`${extraBold}`}>Audio languages</span>
          <span className="text-[#AAAAAA]">
            ಕನ್ನಡ, हिन्दी, മലയാളം, తెలుగు, தமிழ்
          </span>
        </div>
        <div className="flex flex-col gap-2">
          <span className={`${extraBold}`}>Subtitles</span>
          <span className="text-[#AAAAAA]">{data?.data?.title}</span>
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="underline underline-offset-1 flex gap-3">
            {data?.data?.cast[0]}
            <span>{data?.data?.cast[1]},</span>
            <span>{data?.data?.cast[2]}</span>
          </span>
        </div>
        ...
        <div className="text-[#AAAAAA] mt-5">
          By clicking play, you agree to our
          <span className="text-[#FFFFFF] ml-1 un underline underline-offset-1">
            Terms of Use.
          </span>
        </div>
