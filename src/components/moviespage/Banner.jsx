  ...
  return (
    <>
      ...
      <div className="text-white flex font-medium pl-5 md:px-[72px] gap-6 mt-2 lg:hidden block">
        <Link to="/">
          <span>
            <ImHome3 className="text-white text-base mt-1" />
          </span>
        </Link>
        <Link to="/banner">
          <span>Movies</span>
      ...
      <div>
        <h1
          className="text-[#FFFFFF] text-4xl px-5 md:px-[72px] my-7 mb-3
                 font-bold tracking-wide  flex justify-start cursor-default"
        >
          Movies
        </h1>
      </div>
      ...
      >
        {images.map((item, i) => (
          <div key={i} className="w-[93vw] m-auto  relative overflow-hidden">
            ...
            <img
              className="aspect-[16/9] md:aspect-[18/6] lg:w-[91.2vw] w-full m-auto block 
                        cursor-pointer object-cover object-top leading-7 rounded-lg"
              src={images[i].bigImg}
            />
            <section
              className="w-full lg:w-[40%] h-full absolute left-1 top-3 border-5 
                        border-solid border-red md:pl-12 px-2 flex flex-col justify-around"
            >
              <div>
                {i == 0 && (
                  <span
                    className="text-[#FFFFFF] hidden text-2xl mb-[1.3vw]  cursor-default
              ...
              <div>
                ...
                <div className=" lg:flex gap-0.5 hidden mb-8 mt-4">
                  <Link to="/moviedetails">
                    <button
                      className="bg-[#FFFFFF] text-[#00050D] w-[155.48px] h-[62px] text-xl py-2 px-[21px]
