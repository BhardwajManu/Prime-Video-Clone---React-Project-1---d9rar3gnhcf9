            ...
            url(${smallImage})`
                ...
                <div className='md:p-10 p-4 md:absolute text-white  md:w-1/2 top-0 left-0'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <button className='rounded py-3 px-5 text-lg font-semibold hover:bg-[#00a0d6] bg-[#0f79af] w-full md:w-72 mt-2 leading-tight'>Prime Video Mobile Edition at ₹599/year</button>
